...
let ItemDetailsComponent = class ItemDetailsComponent {
    ...
    constructor(service, dialog, tstr) {
    ...
    getAllItemDetails() {
        this.service.getAllItems().then(res => this.result = res);
    ...
    AddOrEditItem(ItemIndex, ItemId) {
        ...
        this.dialog.open(_item_item_component__WEBPACK_IMPORTED_MODULE_4__["ItemComponent"], config).afterClosed().subscribe(res => this.getAllItemDetails());
    }
    deleteItem(ItemId) {
...
let ItemComponent = class ItemComponent {
    constructor(data, dialogref, service, router, tstr) {
        this.data = data;
...
let OrderItemComponent = class OrderItemComponent {
    constructor(data, dialogRef, service, orderservice) {
        this.data = data;
        this.dialogRef = dialogRef;
        this.service = service;
...
let OrderComponent = class OrderComponent {
    constructor(service, dialog, customerService, toastr, route, currentRoute) {
        this.service = service;
        this.dialog = dialog;
    ...
    AddOrEditOrderItem(orderIndex, OrderId) {
        const dialogConf = new _angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialogConfig"]();
        dialogConf.autoFocus = true;
        dialogConf.disableClose = true;
        dialogConf.width = "50%";
        dialogConf.data = { orderIndex, OrderId };
        this.dialog.open(_order_item_order_item_component__WEBPACK_IMPORTED_MODULE_4__["OrderItemComponent"], dialogConf).afterClosed().subscribe(res => this.updateGrandTotal());
    }
    deleteOrderItem(orderItemId, i) {
        if (orderItemId != null) {
    ...
    getAllCus() {
        this.customerService.getAllCustomer().then(res => this.getAllCustomer = res);
    }
    onSubmit(form) {
...
let ItemService = class ItemService {
    ...
    PostItem() {
        let body = Object.assign({}, this.formData, { OrderItems: this.orderItems });
